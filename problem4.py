...
'''
#---------------------
def rank_players_SLG(df):
    #########################################
    ## INSERT YOUR CODE HERE (3 points)
    R3 = df.sort_values(by='SLG', ascending=False)
    #########################################
    return R3
    #-----------------
    '''  
